        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadDateTime = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Questions_QuestionThemes_QuestionThemeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeQuestion", x => new { x.GradesId, x.QuestionsId });
                    table.ForeignKey(
                        name: "FK_GradeQuestion_Grades_GradesId",
                        column: x => x.GradesId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradeQuestion_Questions_QuestionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionAnswers_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SessionAnswers_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeQuestion_QuestionsId",
                table: "GradeQuestion",
                column: "QuestionsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_QuestionThemeId",
                table: "Questions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAnswers_GradeId",
                table: "SessionAnswers",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionAnswers_ImageId",
                table: "SessionAnswers",
                column: "ImageId");
